...
public class ClientMRtest extends AbstractComponent {

    private final DHTServicesEndPoint dht_edp;
    private final String clientId;

    protected ClientMRtest(String uri, DHTServicesEndPoint dht_edp) throws Exception {
        super(1, 0);
    ...
    public void execute() throws Exception {
        this.traceMessage("🧩 Client " + clientId + " démarre...\n");

        int total = 0;
        for (int i = 0; i < 10; i++) {
            String nom = clientId + "-Map-" + i;
            int age = 30 + i;
            total += age;
        ...
        this.traceMessage("✅ [" + clientId + "] Données insérées.\n");

        SelectorI selector = data -> ((String) data.getValue("NOM")).startsWith(clientId + "-Map");
        ...
        this.traceMessage("🎯 [" + clientId + "] Résultat = " + result + "\n");

        assert result == total : "❌ Résultat inattendu pour " + clientId + " : attendu " + total + ", obtenu " + result;

        this.traceMessage("✅ [" + clientId + "] MapReduce validé ✅\n");
