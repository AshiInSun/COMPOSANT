...
public class Node implements ContentAccessSyncI, MapReduceSyncI {
	...
	public Node(int debut, int fin, POJOContentNodeCompositeEndPoint edp_server) throws ConnectionException {
		this.debut = debut;
		this.fin   = fin;
	...
	public void setServer(POJOContentNodeCompositeEndPoint edp_server) throws ConnectionException {
	    this.edp_server = edp_server;
	    this.edp_server.initialiseClientSide(this.edp_server);
	}
